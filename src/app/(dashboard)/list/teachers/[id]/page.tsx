...
import PerformancePieChart from "@/components/@page-components/charts/PieChart";
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
                            ...
                            <div className="w-2/3 flex flex-col justify-between gap-4">
                                <h1 className="text-xl font-semibold">Daphne Chepkirui</h1>
                        ...
                        <div className="flex-1 flex gap-4 justify-between flex-wrap">
                            {/*CARD*/}
                            <div className="bg-white flex gap-4 w-full p-4 rounded-md md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
                ...
                <div className="w-full xl:w-1/3 flex flex-col gap-4">
                    <div className="p-4 rounded-md bg-white ">
                        ...
                        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                            ...
                            <Link href="/" className="p-3 rounded-md bg-lamaPurple">Teacher&apos;s Exams</Link>
                            <Link href="/" className="p-3 rounded-md bg-lamaSky">Teacher&apos;s Assignments</Link>
                        </div>
                    </div>
                    <PerformancePieChart />
                    <Announcements />
